...
<script lang="ts">
	...
	export let text: string = 'Panth!';
	export let asciiFontSize: number = 8;
	export let textFontSize: number = 200;
	export let textColor: string = '#fdf9f3';
	export let planeBaseHeight: number = 8;
	export let enableWaves: boolean = true;
