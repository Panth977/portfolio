...
<script lang="ts">
	...
	export let pixelRatioProp = 2;
	export let shapeSize = 1.2;
	export let roundness = 0.4;
	export let borderSize = 0.05;
	export let circleSize = 0.3;
	export let circleEdge = 0.5;
