...
<div class="pointer-events-none fixed top-0 left-0 z-50 h-full w-full">
	<canvas bind:this={canvas} id="fluid" class="block h-screen w-screen"></canvas>
</div>
