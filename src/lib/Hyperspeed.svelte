...
<script lang="ts">
	...
	export let effectOptions: Partial<HyperspeedOptions> = {};
	let hyperspeed: HTMLDivElement;

	onMount(() => {
		hyperspeed.innerHTML = '';
		...
		const myApp = new App(hyperspeed, mergedOptions);
		myApp.loadAssets().then(myApp.init);
	});
</script>

<div id="lights" bind:this={hyperspeed}><canvas></canvas></div>
